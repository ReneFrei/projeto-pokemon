...
//bjetivo 1 - quando clicar no botão de troca de tema, adicionar a classe modo-escuro no body pra que os estilos do modo escuro sejam aplicados e mudar a imagem pra lua
...
botaoAlterarTema.addEventListener("click", () => {
    ...
    const modoEscuroEstaAtivo = body.classList.contains("modo-escuro");
     ...
     // Toggle altera entre dois fatores subistuiondo as duas linhas--
